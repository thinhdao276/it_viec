...
#resume-skill-item(
  "BI & Data Tools",
  ("Power BI", "DOMO", "Python (Pandas, NumPy, Scikit-learn, Plotly/Dash)", "Alteryx (conceptual understanding, quick to master)", "Tableau (conceptual understanding, quick to master)"),
)
